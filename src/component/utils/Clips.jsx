  ...
  return (
    <>
      <div className="relative h-28 w-32 rounded-xl overflow-hidden group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 sm:h-14">
        ...
        />
        <div className="bg-white/75 blur-effect-theme absolute top-11 left-11 right-0 lg:top-8 lg:left-9 sm:top-4 sm:left-5 rigth-0 opacity-100 z-[100] w-8 h-8 md:w-5 md:h-5 flex items-center justify-center rounded-full">
          <PlayIcon className="icon-style text-slate-900 md:w-3 md:h-3"></PlayIcon>
        </div>
        <video
          autoPlay={true}
          loop={true}
