...
const FlexContent = ({
  ifExists,
  endpoint: { title, heading, url, text, img, btn },
}) => {
  return (
    <>
      <div
        className={`flex items-center justify-between lg:justify-center nike-container lg:flex-col ${
      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          ...
          >
            <button
              type="button"
              className="button-theme bg-slate-900 shadow-slate-9 text-slate-100 py-1.5"
            >
              {btn}
            </button>
          </a>
